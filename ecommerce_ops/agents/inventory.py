        ...
        for item in inventory:
            ...
            if days_left < 14:
                decision = self.create_decision(
                    ...
                    reasoning=(
                        f"SKU {sku} has {current_stock} units left with a daily velocity "
                        f"of {daily_velocity:.2f}. Predicted stockout in {days_left:.1f} days."
                    ),
                    data={
                        "sku": sku,
                        "quantity_to_order": int(daily_velocity * 30),
                        "supplier_id": "DEFAULT",
